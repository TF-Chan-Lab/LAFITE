# AUTOGENERATED! DO NOT EDIT! File to edit: ../04_RTS_identification.ipynb.

# %% auto 0
__all__ = ['AlternativeTerminalFinder', 'TailFinderWrapper']

# %% ../04_RTS_identification.ipynb 2
import warnings
import pandas as pd
