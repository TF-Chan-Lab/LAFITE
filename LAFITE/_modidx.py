  ...
  'syms': { 'LAFITE.lafite_wrapper': { 'LAFITE.lafite_wrapper.LafiteWrapper': ('wrapper.html#lafitewrapper', 'LAFITE/lafite_wrapper.py'),
            ...
            'LAFITE.refine': { 'LAFITE.refine.AttributeCollection': ('refine.html#attributecollection', 'LAFITE/refine.py'),
                               ...
                               'LAFITE.refine.SingleExonReadRefine.single_exon_refine': ( 'refine.html#singleexonreadrefine.single_exon_refine',
                                                                                          'LAFITE/refine.py')},
            'LAFITE.tailFinder': { 'LAFITE.tailFinder.AlternativeTerminalFinder': ( 'rts_identification.html#alternativeterminalfinder',
                                                                                    'LAFITE/tailFinder.py'),
                                   'LAFITE.tailFinder.AlternativeTerminalFinder.__init__': ( 'rts_identification.html#alternativeterminalfinder.__init__',
                                                                                             'LAFITE/tailFinder.py'),
                                   'LAFITE.tailFinder.AlternativeTerminalFinder.optimal_k': ( 'rts_identification.html#alternativeterminalfinder.optimal_k',
                                                                                              'LAFITE/tailFinder.py'),
                                   'LAFITE.tailFinder.AlternativeTerminalFinder.terminal_cluster': ( 'rts_identification.html#alternativeterminalfinder.terminal_cluster',
                                                                                                     'LAFITE/tailFinder.py'),
                                   'LAFITE.tailFinder.TailFinderWrapper': ( 'rts_identification.html#tailfinderwrapper',
                                                                            'LAFITE/tailFinder.py'),
                                   'LAFITE.tailFinder.TailFinderWrapper.__init__': ( 'rts_identification.html#tailfinderwrapper.__init__',
                                                                                     'LAFITE/tailFinder.py'),
                                   'LAFITE.tailFinder.TailFinderWrapper.job_precompute': ( 'rts_identification.html#tailfinderwrapper.job_precompute',
                                                                                           'LAFITE/tailFinder.py'),
                                   'LAFITE.tailFinder.TailFinderWrapper.result_collection': ( 'rts_identification.html#tailfinderwrapper.result_collection',
                                                                                              'LAFITE/tailFinder.py'),
                                   'LAFITE.tailFinder.TailFinderWrapper.return_extremum': ( 'rts_identification.html#tailfinderwrapper.return_extremum',
                                                                                            'LAFITE/tailFinder.py'),
                                   'LAFITE.tailFinder.TailFinderWrapper.run': ( 'rts_identification.html#tailfinderwrapper.run',
                                                                                'LAFITE/tailFinder.py')},
